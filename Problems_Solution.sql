...
FROM
    ...
    -- 03) Identify the highest price pizza.-- 
...
SELECT 
    ROUND(AVG(quant), 0) as Avg_pizza_order_per_day
FROM
    (SELECT 
...
-- 05) Determine three most ordered pizza types based on revenue.
SELECT 
    pizza_types.name AS name_,
...
-- 01)Calculate the percentage contribution 
...
-- 02) Analyze the cumulative revenue genertaed over time
...
-- 13) Determine the top-3 pizza type in each category
-- based on revenue.
